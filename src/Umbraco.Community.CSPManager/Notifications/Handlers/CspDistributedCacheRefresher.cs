	...
	: PayloadCacheRefresherBase<CspDistCacheRefresherNotification, CspSavedNotification>
{
	...
	public static Guid UniqueId => new Guid("8b066ef2-f5ec-4b6f-8121-952c0c7b9d21");
	...
	public override void Refresh(CspSavedNotification[] payloads)
	{
		if (_serverRoleAccessor.CurrentServerRole == ServerRole.Subscriber)
		{
			foreach (var payload in payloads)
			{
				...
				var cacheKey = payload.CspDefinition.IsBackOffice == true
					? CspConstants.BackOfficeCacheKey
					: CspConstants.FrontEndCacheKey;
	...
	public override void RefreshAll()
	{
		if (_serverRoleAccessor.CurrentServerRole == ServerRole.Subscriber)
		{
			...
			_runtimeCache.ClearByKey(CspConstants.BackOfficeCacheKey);
			_runtimeCache.ClearByKey(CspConstants.FrontEndCacheKey);
		}
	}
}
