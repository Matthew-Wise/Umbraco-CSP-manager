...
export class UmbCspSettingsViewElement extends UmbElementMixin(LitElement) {
  ...
  @state()
  private _policyType: 'frontend' | 'backoffice' = 'frontend';
  ...
  constructor() {
    ...
    this.consumeContext(UMB_CSP_MANAGER_WORKSPACE_CONTEXT, (context) => {
      ...
      this._policyType = context?.getPolicyType() || 'frontend';
      ...
      <uui-box headline="Settings">
        <div class="settings-intro">
          <p>
            ...
            <strong>${this._policyType === 'backoffice' ? 'back-office' : 'front-end'}</strong> content.
          </p>
          <div class="status-summary">
            <p>
              CSP is currently <strong>${this._workspaceState.definition.enabled ? 'enabled' : 'disabled'}</strong>
              ${this._workspaceState.definition.enabled && this._workspaceState.definition.reportOnly ? ' and running in report-only mode' : ''}
              ${this._workspaceState.definition.enabled && !this._workspaceState.definition.reportOnly ? ' and actively enforcing policies' : ''}.
            </p>
          </div>
        </div>
        ...
        <div class="settings-grid">
          ...
          <uui-form-layout-item>
            ...
            <span slot="description">
              When enabled, violations are reported but not blocked. 
              Use this to test policies before enforcing them.
            </span>
            <div class="setting-control">
              <uui-toggle 
          ...
          <uui-form-layout-item>
            ...
            <span slot="description">
              ...
              <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy/report-to" target="_blank">
          ...
          <uui-form-layout-item>
            ...
            <span slot="description">
              The endpoint where violation reports will be sent
            </span>
            <div class="setting-control">
              <uui-input 
                label="Report URI"
                ...
                .disabled=${!this._workspaceState.definition.reportingDirective || this._workspaceState.definition.reportingDirective === 'none'}
                @input=${(e: Event) => this._updateDefinitionSetting('reportUri', (e.target as HTMLInputElement).value)}>
              </uui-input>
            </div>
          </uui-form-layout-item>
        </div>
        ...
        <div class="settings-info">
          <uui-box headline="About Content Security Policy" look="placeholder">
            <p>
              ...
              clickjacking, and other code injection attacks by controlling which 
