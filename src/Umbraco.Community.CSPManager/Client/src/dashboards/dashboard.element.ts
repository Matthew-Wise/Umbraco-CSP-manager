...
import { UmbracoCommunityCSPManagerService, UserModel } from "../api";
...
export class ExampleDashboardElement extends UmbElementMixin(LitElement) {
  ...
  #onClickWhoAmI = async (ev: Event) => {
    ...
    const { data, error } = await UmbracoCommunityCSPManagerService.whoAmI();
  ...
  #onClickWhatsTheTimeMrWolf = async (ev: Event) => {
    ...
    const { data, error } = await UmbracoCommunityCSPManagerService.whatsTheTimeMrWolf();
  ...
  #onClickWhatsMyName = async (ev: Event) => {
    ...
    const { data, error } = await UmbracoCommunityCSPManagerService.whatsMyName();
