namespace Umbraco.Community.CSPManager.Core.Services;
...
using Umbraco.Community.CSPManager.Core.Extensions;
...
internal sealed class CspService : ICspService
{
	...
	{
		var cacheKey = isBackOfficeRequest ? CspConstants.BackOfficeCacheKey : CspConstants.FrontEndCacheKey;
